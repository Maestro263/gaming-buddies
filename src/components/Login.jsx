...
import logo from "../images/gamemeet.png"; // Tell webpack this JS file uses this image
...
function SignIn() {
  ...
  return (
    <>
      ...
      <div className="knap">
        <p>
          Behold venligst den gode tone! Vi alle skal være her. Det kan give
          konsekvenser, hvis man ikke overholder denne simple regl!
        </p>
      </div>
    </>
  );
